...
<template>
  ...
  <div
    ...
    class="flex items-center justify-center mt-40 mx-auto transform scale-150"
  >
  ...
  <div v-else class="flex">
    ...
    <div class="md:block hidden">
      ...
      >
        <h2 class="text-xl font-semibold text-gray-700 w-full text-left mb-5">
          Katgorie
        </h2>
        <div class="w-full">
          <RouterLink
    ...
    <div class="flex flex-col mx-auto">
      ...
      <div v-show="isSearching" class="min-h-screen">
        <div v-show="filteredProducts.length !== 0">
          <ItemSection
            sectionName="Wyniki wyszukiwania"
